...
const api = {
    user: {
        policy: {
            ...
            url: `${svHost}server/user/info/policy`,
            method: 'POST'
        },
        login: {
        ...
        register: {
          ...
          url: `${svHost}server/user/info/register`,
            method: 'POST'
        },
        logout: {
            // url: `${host}server/user/logout`,
          url: `${svHost}server/user/info/logout`,
            method: 'GET'
        },
        token: {
            // url: `${host}server/user/token`,
          url: `${svHost}server/user/info/accesstoken`,
            method: 'POST'
        },
        editPassword: {
            // url: `${host}server/user/editPassword`,
          url: `${svHost}server/user/info/editPassword`,
            method: 'POST'
        },
        findPassword: {
            // url: `${host}server/user/findPassword`,
          url: `${svHost}server/user/info/findPassword`,
            method: 'POST'
        },
        self: {
            // url: `${host}server/user/self`,
            // url: `${slimHost}server/new/user/self`,
            url: `${svHost}server/user/info/selfs`,
            method: 'GET'
        },
        editPasswordByFind: {
            // url: `${host}server/user/editPasswordByFind`,
          url: `${svHost}server/user/info/editPasswordByFind`,
            method: 'POST'
        },
        editProfile: {
            // url: `${host}server/user/editProfile`,
          url: `${svHost}server/user/info/editProfile`,
            method: 'POST'
        },
        bindPhone: {
            // url: `${host}server/user/bindPhone`,
          url: `${svHost}server/user/info/bindPhone`,
            method: 'POST'
        },
        bindWechat: {
            // url: `${host}server/user/bindWechat`,
          url: `${svHost}server/user/info/bindWechat`,
            method: 'POST'
        },
        unbindWechat: {
            // url: `${host}server/user/unbindWechat`,
          url: `${svHost}server/user/info/unbindWechat`,
            method: 'POST'
        },
        unbindPhone: {
            // url: `${host}server/user/unbindWechat`,
        ...
        evaluatedList: {
          ...
          url: `${svHost}server/user/info/evaluatedList`,
            method: 'GET'
        },
        certInfo: {
    ...
    cart: {
        ...
        check: {
          ...
          url: `${svHost}server/cart/check`,
            method: 'POST'
        },
        destroy: {
            // url: `${host}server/cart/destroy`,
          url: `${svHost}server/cart/destroy`,
            method: 'POST'
        },
        totalNum: {
    ...
    goodsCategory: {
        ...
        info: {
          ...
          url: `${svHost}server/goods/categoriesinfo`,
            method: 'GET'
        }
    },
    goods: {
    ...
    goodsEvaluate: {
        ...
        mine: {
          ...
          url: `${svHost}server/evaluate/mine`,
            method: 'GET'
        },
        add: {
            // url: `${host}server/goodsevaluate/add`,
          url: `${svHost}server/evaluate/add`,
            method: 'POST'
        },
        append: {
            // url: `${host}server/goodsevaluate/append`,
          url: `${svHost}server/evaluate/append`,
            method: 'POST'
        },
        info: {
            // url: `${host}server/goodsevaluate/detail`,
          url: `${svHost}server/evaluate/info`,
            method: 'GET'
        },
        isEvaluated: {
            // url: `${host}server/goodsevaluate/isEvaluated`,
          url: `${svHost}server/evaluate/isEvaluated`,
            method: 'GET'
        },
    },
    shopsCollect: {
        ...
        del: {
          ...
          url: `${svHost}server/user/collect/delshop`,
            method: 'POST'
        },
    },
    goodsCollect: {
        ...
        del: {
          ...
          url: `${svHost}server/user/collect/delgood`,
            method: 'POST'
        },
    },
    help: {
        list: {
          ...
          url: `${svHost}server/help/list`,
            method: 'GET'
        },
        info: {
            // url: `${slimHost}server/new/help/info`,
           url: `${svHost}server/help/info`,
            method: 'GET'
        },
        add: {
    ...
    address: {
        setDefault: {
            ...
            url: `${svHost}server/user/address/setDefault`,
            method: 'POST'
        },
        getDefault: {
        ...
        types: {
          ...
          url: `${svHost}server/user/address/types`,
            method: 'GET'
        },
    },
    wechat: {
        buildConfig: {
          ...
          url: `${svHost}server/wechat/buildConfig`,
            method: 'GET'
        },
        code: {
            // url: `${host}server/wechat/code`,
          url: `${svHost}server/wechat/code`,
            method: 'GET'
        },
        userinfo: {
            // url: `${host}server/wechat/userinfo`,
          url: `${svHost}server/wechat/userinfo`,
            method: 'GET'
        },
    },
    order: {
        ...
        deliverInfo: {
           ...
           url: `${svHost}server/user/order/deliverInfo`,
            method: 'GET'
        },
        logistics: {
        ...
        goodsList: {
          ...
          url: `${svHost}server/user/order/goodsList`,
            method: 'GET'
        },
        goodsInfo: {
            // url: `${host}server/order/goodsInfo`,
            url: `${svHost}server/user/order/goodsinfo`,
            method: 'GET'
        },
    },
    refund: {
        reasonList: {
            ...
            url: `${svHost}server/user/refund/reasonList`,

            method: 'GET'
        },
        apply: {
            // url: `${host}server/orderrefund/apply`,
            url: `${svHost}server/user/refund/apply`,
            method: 'POST'
        },
        list: {
            // url: `${host}server/orderrefund/list`,
            url: `${svHost}server/user/refund/lists`,
            method: 'GET'
        },
        info: {
            // url: `${host}server/orderrefund/info`,
            url: `${svHost}server/user/refund/info`,
            method: 'GET'
        },
        setTrackingNo: {
            // url: `${host}server/orderrefund/setTrackingNo`,
          url: `${svHost}server/user/refund/setTrackingNo`,
            method: 'POST'
        },
        revoke: {
            // url: `${host}server/orderrefund/revoke`,
            url: `${svHost}server/user/refund/revoke`,
            method: 'POST'
        },
    },
    page: {
        ...
        info: {
          ...
          url: `${svHost}server/homepage/info`,
            method: 'GET'
        },
        listHomeProducts: {
            // url: `${slimHost}server/new/home/goods`,
          url: `${svHost}server/homepage/goods`,
            method: 'GET'
        },
    },
    payment: {
