...
export class GoodsListHomeInterface extends Interface {
    list;
    total_number;
    ...
    constructor(param) {
        ...
        try {
            ...
            this.list = param.list.map(function (item) {
                return new GoodsListInfoHomeInterface(item)
            })
        } catch (e) {
            throw new Exception(e, 'GoodsListHomeInterface interface attribute error')
        }
    }
}

export class GoodsListInfoHomeInterface extends Interface {
    id;
    title;
    category_ids;
    image;
    ...
    constructor(param) {
        ...
        try {
            ...
            this.price_original = param.price_original
        } catch (e) {
            throw new Exception(e, 'GoodsListInfoHomeInterface interface attribute error')
        }
    }
}
